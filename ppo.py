...
def parse_args():
    ...
    parser.add_argument("--repo-id", type=str, default="hussamalafandi/ppo-CartPole-v1", help="id of the model repository from the Hugging Face Hub {username/repo_name}")
